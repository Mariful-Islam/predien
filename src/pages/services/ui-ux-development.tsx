            ...
            <div
              ...
              >
                ...
                <h3 className="text-slate-50 dark:text-slate-300 text-2xl md:text-5xl font-semibold text-center mt-4">
                  Building Clean Minimal Modern User Interface and User Experience
                </h3>
                ...
                <Link
                  href="#"
                  className=" ml-0 text-center xs:ml-4 bg-red-500 px-8 py-2 text-white rounded-md hover:bg-red-700 duration-200"
                >
                  Learn more
                </Link>
              </div>
