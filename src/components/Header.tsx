...
function Header() {
  ...
  return (
    <div className='max-w-[1200px] mx-auto z-40'>
      <div className={`flex justify-between items-center  w-full px-4 sm:px-20  ${isVisible ? 'bg-white shadow-lg dark:bg-black fixed left-0 right-0 py-2 ' : 'py-2 md:py-4'} duration-500 z-50`}>
