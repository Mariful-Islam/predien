    ...
    <div className="relative ">
      <div className="z-20 relative">
        ...
        <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-20 flex flex-col justify-center h-[320px]">
          <h1
            className={`text-orange-500 text-xl font-bold text-center`}
            data-aos="fade-up"
          ...
          >
            <Link
              ...
              className={`group border text-center border-orange-500 rounded-md px-8 py-1 text-orange-500 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-950 duration-200 flex gap-2 items-center justify-center`}
            >
              Contact{" "}
            ...
            <Link
              href="#intro"
              className={`flex gap-2 items-center justify-center group ml-0 text-center xs:ml-4 bg-orange-500 hover:bg-orange-700 px-8 py-1 text-white rounded-md  duration-200`}
              role="button"
            >
              Learn more
