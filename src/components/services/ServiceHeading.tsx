    ...
    <>
      ...
      <div className="relative mt-[72px] ">
        <div className="z-20 relative">
          <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-20 flex flex-col justify-center h-[430px]">
            <h1
        ...
        <div className="absolute top-0 z-10 ">
          <div className="backdrop-blur-3xl bg-black opacity-50 h-full w-full absolute top-0 right-0"></div>
          <Image
            src={data.bgImage}
            alt=""
